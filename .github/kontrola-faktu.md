...
**Kam dávka sahá.** Ostrá verze webu se **nezměnila** — `index.html`, `/faq`, `/docs/prvni-kroky`
i `sitemap.xml` jsou bajtově shodné s `main`. Všechny úpravy leží v nové stránce
